...
export function LandingPageComponent() {
  ...
  return (
    ...
    >
      ...
      <main>
        <section
          className="container mx-auto px-4 py-20 text-center flex-grow relative z-10 "
          style={{ minHeight: "100vh" }}
        >
          <h1 className="text-5xl font-bold mb-6">
            The Extreme Problem Solver of Medical Industry
          </h1>
          <p
            className={`text-xl ${
          ...
          >
            Revolutionizing healthcare with cutting-edge solutions for patients
            and professionals alike. Experience the future of medical services
            today.
          </p>
            ...
            {[
              {
                ...
                description:
                  "Connect with top medical professionals for personalized care.",
              },
              {
                icon: <Pill className="h-10 w-10 text-green-500" />,
                title: "Medication Management",
                description:
                  "Easy tracking and reminders for your prescriptions.",
              },
              {
                icon: <ShoppingCart className="h-10 w-10 text-green-500" />,
                title: "Medical Supplies",
                description:
                  "Quick access to essential medical supplies and equipment.",
              },
            ].map((feature, index) => (
              <Card
                key={index}
              ...
              {[
                {
                  ...
                  title: "Med-o-Chat",
                  description:
                    "Multilingual real-time chat platform with doctors from pan India.",
                ...
                },
                {
                  ...
                  title: "Med-o-Shop",
                  description:
                    "Affordable medicines and medical accessories at company-set prices.",
                  action: "Shop Now",
                },
                {
                  icon: <Brain className="h-16 w-16 text-green-500 mb-4" />,
                  title: "Med-o-AI",
                  description:
                ...
                {
                  icon: <Eye className="h-16 w-16 text-green-500 mb-4" />,
                  title: "Med-o-Lens",
                  description:
                    "Advanced imaging for precise medical analysis and early detection.",
                  action: "Learn More",
                },
              ].map((service, index) => (
                <Card
                ...
                >
                  <CardContent className="flex flex-col items-center p-6 h-full">
                    ...
                    <Button className="mt-auto bg-green-600 hover:bg-green-700 text-white transition-colors">
                      {service.action}
                    </Button>
                  </CardContent>
                </Card>
        ...
        >
          ...
          >
            Subscribe to our newsletter for the latest medical innovations and
            exclusive offers.
          </p>
          <form
      ...
      <footer
        ...
        } py-8 relative z-10 transition-colors duration-300`}
      >
